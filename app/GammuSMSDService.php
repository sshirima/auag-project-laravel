...
class GammuSMSDService {
    ...
    public static function getSMSServiceStatus() {
        ...
        return GammuSMSDService::runCommand($command);
    }
    ...
    public function getConfigFile() {
        ...
        $filename = new SplFileObject(GammuSMSDService::$FILEPATH);
    ...
    public function saveSmsdConfigs($configs) {
        ...
        $replaced = false;
        $file_reading = fopen(GammuSMSDService::$FILEPATH, 'r');
        $file_writing = fopen(GammuSMSDService::$FILEPATH_TEMP, 'w');
        $responce = false;
        ...
        if ($replaced) {
            unlink(GammuSMSDService::$FILEPATH);
            rename(GammuSMSDService::$FILEPATH_TEMP, GammuSMSDService::$FILEPATH);
            $responce = true;
        } else {
            unlink(GammuSMSDService::$FILEPATH_TEMP);
        }
        return $responce;
    }
