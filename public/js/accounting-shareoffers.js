...
var table;
var columnNames = new Array('offer_id','offer_shareid','acc_name','offer_price','offer_units','offer_amount','share_currency','created_at');
...
$(document).ready(function () {
    ...
    table.toolbar[0].buttons[0] = {commandName: "insert", caption: 'Buy share'};
